...
public class MainJDBC {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        var connection = MainJDBC.getConnection();
        ...
        var depositDatabase = new DepositDatabase(connection);

        Service service = new Service(clientDatabase, transactionDatabase, accountDatabase, savingsAccountDatabase, depositDatabase);
